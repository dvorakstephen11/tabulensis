...
WXD_EXPORTED wxd_XmlResource_t*
...
WXD_EXPORTED int
wxd_XmlResource_GetXRCID(const char* name);

// Find a child window by XRC name
WXD_EXPORTED wxd_Window_t*
wxd_Window_FindWindowByXRCName(wxd_Window_t* parent, const char* xrc_name);
