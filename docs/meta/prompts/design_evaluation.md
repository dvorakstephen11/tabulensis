...
2. **`excel_diff_meta_programming.md`** — The development process philosophy. Understanding the *how* of development reveals what the maintainers value.

3. **`excel_diff_difficulty_analysis.md`** — The difficulty ranking illuminates where complexity pressure is highest. Well-designed systems gracefully absorb difficulty at these points.

4. **`excel_diff_product_differentiation_plan.md`** — The competitive positioning reveals the system's raison d'être. Architecture should serve product vision.

5. **`excel_diff_testing_plan.md`** — The testing philosophy reveals what invariants the system considers sacred.
