# Cycle Checklist: 2025-12-23-branch-1
...
- [ ] Decision record created (`plans/2025-12-23-branch-1.yml`)
- [ ] Mini-spec written (`plans/2025-12-23-branch-1.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-23-branch-1/`
