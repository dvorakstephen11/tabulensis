# Cycle Checklist: 2025-11-27-datamashup-framing
...
- [ ] Decision record created (`plans/2025-11-27-datamashup-framing.yml`)
- [ ] Mini-spec written (`plans/2025-11-27-datamashup-framing.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-11-27-datamashup-framing/`
