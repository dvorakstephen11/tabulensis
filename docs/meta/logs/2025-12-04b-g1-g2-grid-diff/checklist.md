# Cycle Checklist: 2025-12-04b-g1-g2-grid-diff
...
- [ ] Decision record created (`plans/2025-12-04b-g1-g2-grid-diff.yml`)
- [ ] Mini-spec written (`plans/2025-12-04b-g1-g2-grid-diff.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-04b-g1-g2-grid-diff/`
