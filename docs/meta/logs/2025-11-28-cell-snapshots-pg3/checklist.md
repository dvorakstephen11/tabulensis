# Cycle Checklist: 2025-11-28-cell-snapshots-pg3
...
- [ ] Decision record created (`plans/2025-11-28-cell-snapshots-pg3.yml`)
- [ ] Mini-spec written (`plans/2025-11-28-cell-snapshots-pg3.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-11-28-cell-snapshots-pg3/`
