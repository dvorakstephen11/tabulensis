# Cycle Checklist: 2025-12-02c-m5-section1-splitting
...
- [ ] Decision record created (`plans/2025-12-02c-m5-section1-splitting.yml`)
- [ ] Mini-spec written (`plans/2025-12-02c-m5-section1-splitting.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-02c-m5-section1-splitting/`
