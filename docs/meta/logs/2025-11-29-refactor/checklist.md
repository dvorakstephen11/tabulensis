# Cycle Checklist: 2025-11-29-refactor
...
- [ ] Decision record created (`plans/2025-11-29-refactor.yml`)
- [ ] Mini-spec written (`plans/2025-11-29-refactor.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-11-29-refactor/`
