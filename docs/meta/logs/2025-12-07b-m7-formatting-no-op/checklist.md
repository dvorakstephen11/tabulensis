# Cycle Checklist: 2025-12-07b-m7-formatting-no-op
...
- [ ] Decision record created (`plans/2025-12-07b-m7-formatting-no-op.yml`)
- [ ] Mini-spec written (`plans/2025-12-07b-m7-formatting-no-op.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-07b-m7-formatting-no-op/`
