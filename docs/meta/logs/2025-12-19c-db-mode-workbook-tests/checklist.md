# Cycle Checklist: 2025-12-19c-db-mode-workbook-tests
...
- [ ] Decision record created (`plans/2025-12-19c-db-mode-workbook-tests.yml`)
- [ ] Mini-spec written (`plans/2025-12-19c-db-mode-workbook-tests.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-19c-db-mode-workbook-tests/`
