# Cycle Checklist: 2026-01-05-high-roi-hardening
...
- [ ] Decision record created (`plans/2026-01-05-high-roi-hardening.yml`)
- [ ] Mini-spec written (`plans/2026-01-05-high-roi-hardening.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2026-01-05-high-roi-hardening/`
