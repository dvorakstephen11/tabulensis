# Cycle Checklist: 2025-12-03b-m4-permissions-metadata
...
- [ ] Decision record created (`plans/2025-12-03b-m4-permissions-metadata.yml`)
- [ ] Mini-spec written (`plans/2025-12-03b-m4-permissions-metadata.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-03b-m4-permissions-metadata/`
