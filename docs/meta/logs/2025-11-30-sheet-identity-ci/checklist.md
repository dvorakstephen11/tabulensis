# Cycle Checklist: 2025-11-30-sheet-identity-ci
...
- [ ] Decision record created (`plans/2025-11-30-sheet-identity-ci.yml`)
- [ ] Mini-spec written (`plans/2025-11-30-sheet-identity-ci.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-11-30-sheet-identity-ci/`
