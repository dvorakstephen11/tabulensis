# Cycle Checklist: 2026-01-02-phase-8
...
- [ ] Decision record created (`plans/2026-01-02-phase-8.yml`)
- [ ] Mini-spec written (`plans/2026-01-02-phase-8.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2026-01-02-phase-8/`
