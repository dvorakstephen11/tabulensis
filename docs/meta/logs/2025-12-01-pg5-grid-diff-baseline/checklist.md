# Cycle Checklist: 2025-12-01-pg5-grid-diff-baseline
...
- [ ] Decision record created (`plans/2025-12-01-pg5-grid-diff-baseline.yml`)
- [ ] Mini-spec written (`plans/2025-12-01-pg5-grid-diff-baseline.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-01-pg5-grid-diff-baseline/`
