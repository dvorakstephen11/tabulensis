# Cycle Checklist: 2025-12-31-13-phase-plan-phase-3
...
- [ ] Decision record created (`plans/2025-12-31-13-phase-plan-phase-3.yml`)
- [ ] Mini-spec written (`plans/2025-12-31-13-phase-plan-phase-3.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-31-13-phase-plan-phase-3/`
