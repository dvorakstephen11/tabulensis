# Cycle Checklist: 2025-12-06d-g13-fuzzy-row-move
...
- [ ] Decision record created (`plans/2025-12-06d-g13-fuzzy-row-move.yml`)
- [ ] Mini-spec written (`plans/2025-12-06d-g13-fuzzy-row-move.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-06d-g13-fuzzy-row-move/`
