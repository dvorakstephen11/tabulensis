# Cycle Checklist: 2025-12-19-simplicity-and-maintainability
...
- [ ] Decision record created (`plans/2025-12-19-simplicity-and-maintainability.yml`)
- [ ] Mini-spec written (`plans/2025-12-19-simplicity-and-maintainability.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-19-simplicity-and-maintainability/`
