# Cycle Checklist: 2025-12-24a-design-improvements
...
- [ ] Decision record created (`plans/2025-12-24a-design-improvements.yml`)
- [ ] Mini-spec written (`plans/2025-12-24a-design-improvements.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-24a-design-improvements/`
