# Cycle Checklist: 2025-12-22-branch-7
...
- [ ] Decision record created (`plans/2025-12-22-branch-7.yml`)
- [ ] Mini-spec written (`plans/2025-12-22-branch-7.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-22-branch-7/`
