# Cycle Checklist: 2025-12-04c-m6-textual-m-diff
...
- [ ] Decision record created (`plans/2025-12-04c-m6-textual-m-diff.yml`)
- [ ] Mini-spec written (`plans/2025-12-04c-m6-textual-m-diff.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-04c-m6-textual-m-diff/`
