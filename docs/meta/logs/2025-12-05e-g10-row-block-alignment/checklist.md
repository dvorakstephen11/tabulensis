# Cycle Checklist: 2025-12-05e-g10-row-block-alignment
...
- [ ] Decision record created (`plans/2025-12-05e-g10-row-block-alignment.yml`)
- [ ] Mini-spec written (`plans/2025-12-05e-g10-row-block-alignment.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-05e-g10-row-block-alignment/`
