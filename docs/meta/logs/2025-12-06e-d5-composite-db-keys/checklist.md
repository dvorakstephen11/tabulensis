# Cycle Checklist: 2025-12-06e-d5-composite-db-keys
...
- [ ] Decision record created (`plans/2025-12-06e-d5-composite-db-keys.yml`)
- [ ] Mini-spec written (`plans/2025-12-06e-d5-composite-db-keys.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-06e-d5-composite-db-keys/`
