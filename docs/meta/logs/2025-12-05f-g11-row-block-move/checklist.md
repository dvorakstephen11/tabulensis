# Cycle Checklist: 2025-12-05f-g11-row-block-move
...
- [ ] Decision record created (`plans/2025-12-05f-g11-row-block-move.yml`)
- [ ] Mini-spec written (`plans/2025-12-05f-g11-row-block-move.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-05f-g11-row-block-move/`
