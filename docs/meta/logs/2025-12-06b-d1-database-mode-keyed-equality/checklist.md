# Cycle Checklist: 2025-12-06b-d1-database-mode-keyed-equality
...
- [ ] Decision record created (`plans/2025-12-06b-d1-database-mode-keyed-equality.yml`)
- [ ] Mini-spec written (`plans/2025-12-06b-d1-database-mode-keyed-equality.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-06b-d1-database-mode-keyed-equality/`
