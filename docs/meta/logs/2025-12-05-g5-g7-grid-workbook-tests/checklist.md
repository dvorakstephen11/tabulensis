# Cycle Checklist: 2025-12-05-g5-g7-grid-workbook-tests
...
- [ ] Decision record created (`plans/2025-12-05-g5-g7-grid-workbook-tests.yml`)
- [ ] Mini-spec written (`plans/2025-12-05-g5-g7-grid-workbook-tests.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-05-g5-g7-grid-workbook-tests/`
