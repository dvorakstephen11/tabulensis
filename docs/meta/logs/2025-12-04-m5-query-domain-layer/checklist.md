# Cycle Checklist: 2025-12-04-m5-query-domain-layer
...
- [ ] Decision record created (`plans/2025-12-04-m5-query-domain-layer.yml`)
- [ ] Mini-spec written (`plans/2025-12-04-m5-query-domain-layer.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-04-m5-query-domain-layer/`
