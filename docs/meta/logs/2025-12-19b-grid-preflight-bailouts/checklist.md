# Cycle Checklist: 2025-12-19b-grid-preflight-bailouts
...
- [ ] Decision record created (`plans/2025-12-19b-grid-preflight-bailouts.yml`)
- [ ] Mini-spec written (`plans/2025-12-19b-grid-preflight-bailouts.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-19b-grid-preflight-bailouts/`
