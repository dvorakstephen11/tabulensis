# Cycle Checklist: 2025-12-07-m-ast-equality
...
- [ ] Decision record created (`plans/2025-12-07-m-ast-equality.yml`)
- [ ] Mini-spec written (`plans/2025-12-07-m-ast-equality.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-07-m-ast-equality/`
