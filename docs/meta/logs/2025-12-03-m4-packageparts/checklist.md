# Cycle Checklist: 2025-12-03-m4-packageparts
...
- [ ] Decision record created (`plans/2025-12-03-m4-packageparts.yml`)
- [ ] Mini-spec written (`plans/2025-12-03-m4-packageparts.md`) with scope, behavioral contract, and constraints
...
- [ ] Start new chat, paste instruction from clipboard, attach collated files from `~/Downloads/2025-12-03-m4-packageparts/`
